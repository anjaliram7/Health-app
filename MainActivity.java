        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                        ...
                        !nosmell.isChecked() && !vomit.isChecked())
                {
                    symptoms="Cold cough";
                    diagnosis="only cold";
                    Toast.makeText(getApplicationContext(),"only
                            cold",Toast.LENGTH_SHORT).show();
                }
                if(cold.isChecked() && fever.isChecked() && !nosmell.isChecked() && !vomit.isChecked())
                {
                    Toast.makeText(getApplicationContext(),"normal
                            fever",Toast.LENGTH_SHORT).show();
                            symptoms="Cold cough"+"\n"+"fever";
                    diagnosis="normal fever";
                }
                if(cold.isChecked() && fever.isChecked() && !nosmell.isChecked() && vomit.isChecked())
                {
                    Toast.makeText(getApplicationContext(),"viral
                            fever",Toast.LENGTH_SHORT).show();
                            symptoms="Cold cough"+"\n"+"fever" +"\n"+"vomiting";
                ...
                if(cold.isChecked() && fever.isChecked() && nosmell.isChecked() && vomit.isChecked())
                {
                    Toast.makeText(getApplicationContext(),"covid",Toast.LENGTH_SHORT).show(); symptoms="Cold cough"+"\n"+"fever" +"\n"+"vomiting"+"\n"+"no smell";
                    diagnosis="covid";
                }
